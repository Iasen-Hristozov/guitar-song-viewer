...
//    int[] codelist=new int[1280]; {for(int i=0;i!=1280;++i) codelist[i]=i;}
...
//    entrytab=new List[1280]; for(int i=0;i!=1280;++i) entrytab[i]=new List();
...
//     String args1[] = {"родина", "etc/hyphen/ruhyphal.tex", "etc/hyphen/koicodes.txt"};
//     String args1[] = {"трагедия", "etc/hyphen/hyph-bg1.tex", "etc/hyphen/koicodes.txt"};
     String args1[] = {"трагедия", "etc/hyphen/hyph-bg.tex"};
//     String args1[] = {"\u0440\u043e\u0434\u0438\u043d\u0430", "etc/hyphen/hyph-bg.tex"};
   ...
   java.io.InputStream table=null;
   try {
     table=new java.io.BufferedInputStream(new java.io.FileInputStream(args1[1]));
   } catch(java.io.IOException e) {
     System.err.println("cannot open hyphenation table "+args1[1]+": "+e.toString());
     System.exit(1);
   }
   int[] codelist=new int[256];
   for(int i=0;i!=256;++i) codelist[i]=i;
   if(args1.length==3) {
     java.io.BufferedReader codes=null;
     try {
  codes=new java.io.BufferedReader(new java.io.FileReader(args1[2]));
     } catch(java.io.IOException e) {
  System.err.println("cannot open code list"+args1[2]+": "+e.toString());
  System.exit(1);
     }
     try {
  String line;
  ...
  System.exit(1);
   ...
   System.out.println(args1[0]+" -> "+hyphenator.hyphenate(args1[0]));
 }
}
